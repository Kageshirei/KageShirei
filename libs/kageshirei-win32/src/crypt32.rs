...
pub type CertOpenSystemStoreW =
    unsafe extern "system" fn(hProv: *const c_void, szSubsystemProtocol: *const u16) -> *const c_void;
...
pub type CertFreeCertificateContext = unsafe extern "system" fn(pCertContext: *const CertContext) -> i32;

pub type CertCloseStore = unsafe extern "system" fn(hCertStore: *const c_void, dwFlags: c_ulong) -> i32;
...
impl Crypt32 {
    pub fn new() -> Self {
        Crypt32 {
            cert_open_system_store_w:       unsafe { core::mem::transmute(core::ptr::null::<core::ffi::c_void>()) },
            cert_find_certificate_in_store: unsafe { core::mem::transmute(core::ptr::null::<core::ffi::c_void>()) },
            cert_free_certificate_context:  unsafe { core::mem::transmute(core::ptr::null::<core::ffi::c_void>()) },
            cert_close_store:               unsafe { core::mem::transmute(core::ptr::null::<core::ffi::c_void>()) },
        }
    }
}
