...
pub mod sql_types {
    /// The `agent_command_status` SQL type
    ///
    /// (Automatically generated by Diesel.)
    #[derive(diesel::query_builder::QueryId, diesel::sql_types::SqlType, std::fmt::Debug, Clone, PartialEq)]
    #[diesel(postgres_type(name = "agent_command_status"))]
    pub struct AgentCommandStatus;

    /// The `agent_fields` SQL type
    ///
    /// (Automatically generated by Diesel.)
    #[derive(diesel::query_builder::QueryId, diesel::sql_types::SqlType, std::fmt::Debug, Clone, PartialEq)]
    #[diesel(postgres_type(name = "agent_fields"))]
    pub struct AgentFields;

    /// The `filter_operator` SQL type
    ///
    /// (Automatically generated by Diesel.)
    #[derive(diesel::query_builder::QueryId, diesel::sql_types::SqlType, std::fmt::Debug, Clone, PartialEq)]
    #[diesel(postgres_type(name = "filter_operator"))]
    pub struct FilterOperator;

    /// The `log_level` SQL type
    ///
    /// (Automatically generated by Diesel.)
    #[derive(diesel::query_builder::QueryId, diesel::sql_types::SqlType, std::fmt::Debug, Clone, PartialEq)]
    ...
    /// The `logical_operator` SQL type
    ///
    /// (Automatically generated by Diesel.)
    #[derive(diesel::query_builder::QueryId, diesel::sql_types::SqlType, std::fmt::Debug, Clone, PartialEq)]
    #[diesel(postgres_type(name = "logical_operator"))]
