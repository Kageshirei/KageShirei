use crate::{
    nt_close, nt_open_process, nt_open_process_token, nt_query_information_process,
    nt_query_information_token,
};
use core::{ffi::c_void, mem::size_of, ptr::null_mut};
use rs2_winapi::{
    ntdef::{AccessMask, ClientId, ObjectAttributes, HANDLE, OBJ_CASE_INSENSITIVE, ULONG},
